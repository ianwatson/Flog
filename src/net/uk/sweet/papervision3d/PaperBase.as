...
package net.uk.sweet.papervision3d
{
	...
	public class PaperBase extends Sprite { //Must be "extends Sprite"
		...
		protected var viewport:Viewport3D; // The Viewport
		protected var renderer:BasicRenderEngine; // Rendering engine
		
		protected var current_scene:Scene3D;
		protected var current_camera:CameraObject3D;
		protected var current_viewport:Viewport3D;
		// -- Scenes -- //
		protected var default_scene:Scene3D; // A Scene
		// -- Cameras --//
		protected var default_camera:Camera3D; // A Camera
